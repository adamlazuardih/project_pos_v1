...
$query = "SELECT * FROM `orders` LEFT JOIN order_details USING(OrderID) LEFT JOIN products ON(products.ProductID = order_details.ProductID) WHERE OrderID = '$id';";
$sql = mysqli_query($conn, $query);

$data = mysqli_fetch_array($sql);

$query2 = "SELECT * FROM `orders` LEFT JOIN order_details USING(OrderID) LEFT JOIN products ON(products.ProductID = order_details.ProductID) WHERE OrderID = '$id';";
  ...
  <div id="page-wrap">
    ...
    <div id="customer">
      ...
      <table id="meta">
        ...
        <td>
          <p id="date" disabled><?= $data['OrderID'] ?></p>
        </td>
        </tr>
